...
class ImageUndistortionNode:
    def __init__(self):
        try:
            rospy.init_node('image_undistortion_node_paul', anonymous=False, xmlrpc_port=45200, tcpros_port=45201)
            self.image_pub = rospy.Publisher('/camera/image_undistorted_paul', CompressedImage, queue_size=1)
            ...
            rospy.loginfo("Paul Undistort Node Initialized")
...
if __name__ == '__main__':
    try:
        ...
        rospy.logerr("[Image processing] Error starting: %s", e)